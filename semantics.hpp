...
public:
  ...
  void enterCase_condition(PascalSParser::Case_conditionContext *ctx) override{};
  void exitCase_condition(PascalSParser::Case_conditionContext *ctx) override;

  void enterCase_statement(PascalSParser::Case_statementContext *ctx) override;
  void exitCase_statement(PascalSParser::Case_statementContext *ctx) override;
...
*/
  ...
  void enterFor_body(PascalSParser::For_bodyContext *ctx) override;
  void exitFor_body(PascalSParser::For_bodyContext *ctx) override;

  void enterFor_condition(PascalSParser::For_conditionContext *ctx) override;
  void exitFor_condition(PascalSParser::For_conditionContext *ctx) override;

  void enterFor_init(PascalSParser::For_initContext *ctx) override{};
  void exitFor_init(PascalSParser::For_initContext *ctx) override;
